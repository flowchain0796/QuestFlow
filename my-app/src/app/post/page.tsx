...
const BountyFormPage: React.FC = () => {
    ...
    const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
        ...
        const contractAddress = '0x3a71C8AE02fC231B413806D9A5C20d3D4A09040a'
        const earnedFLOW = 1;
        ...
        // mint();
        console.log(earnedFLOW, "========inside withdraw===")

        await (await movieRev.donate(walletAddress, "0xB702203B9FD0ee85aeDB9d314C075D480d716635", ethers.parseUnits(earnedFLOW.toString(), 18))).wait();
